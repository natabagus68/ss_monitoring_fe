...
import useChangeEquipmentModel from './ChangeEquipmentModel'
import ModalConfirm from '@common/components/modals/ModalConfirm'

export default function ChangeEquipment() {
  const change = useChangeEquipmentModel()
  return (
    <>
      ...
      <main className="w-screen h-screen overflow-y-auto bg-[#212121] border-4 border-white flex flex-col">
        <div className="grid grid-cols-4">
          ...
          <div className="col-span-2 flex justify-center items-center border-2 py-4 bg-[#0D2243]">
            <span className={`text-white font-[700] text-5xl `}>Change Equipment</span>
          </div>
          ...
          <div className='col-span-4 grid grid-cols-2  '>
            <div className='border-2 p-4 '>
              <span className='col-span-4 text-[#FFC107] font-bold text-3xl px-8 py-6 whitespace-nowrap'>Equipment No - Equipment Name</span>
            ...
            <div className='border-2 p-4'>
              ...
              <form onSubmit={change.handleSave}  className='flex flex-col gap-4 pt-5'>
                <span className='text-[#FAB005] font-bold text-2xl'>Equipment No - Equipment Name</span>
