...
import useProductionProblemFormModel from './ProductionProblemFormModel'
import ModalConfirm from '@common/components/modals/ModalConfirm'
import BackIcon from '@common/components/icons-new/BackIcon'
import DateTime from '@common/components/DateTime'

export default function ProductionProblemForm() {
  const form = useProductionProblemFormModel()
  return (
    <>
      ...
      <div className='col-span-4 flex flex-col p-5'>
        ...
        <div className='flex flex-row gap-3 w-full'>
            <div className='flex flex-col  w-1/2 gap-3'>
              <label htmlFor="partNumber" className='font-bold text-3xl text-[#FFC107]'>Start Time</label>
              <select name="" id=""  className='p-5 text-black bg-white text-2xl w-full disabled:bg-[#B8B6B6] '>
                <option value="12:20">12:20</option>
              </select>
            </div>
            <div className='flex flex-col w-1/2 gap-3'>
              <label htmlFor="partNumber" className='font-bold text-3xl text-[#FFC107]'>End Time</label>
              <select name="" id=""  className='p-5 text-black bg-white text-2xl w-full disabled:bg-[#B8B6B6] '>
          ...
          <label htmlFor="partNumber" className='font-bold text-3xl text-[#FFC107]'>Problem</label>
