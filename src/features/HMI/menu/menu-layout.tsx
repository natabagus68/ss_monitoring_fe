    ...
    <main className="w-screen h-screen overflow-y-auto bg-[#212121] border-4 border-white flex flex-col">
      <div className="grid grid-cols-6">
        ...
        <div className="col-span-3 flex justify-center items-center border-2 py-4 bg-[#0D2243]">
          ...
          <span className={`text-white font-[700] text-5xl `}>
            Assy Cabin 01
          </span>
        </div>
        ...
        <div className="col-span-2 py-4 items-center flex gap-3 px-5 border-2">
          ...
          <span
            className={`text-white font-[700] text-3xl`}
          >{`Machine A`}</span>
        </div>
        ...
        <div className="col-span-4 row-span-4 px-10 py-12 grid grid-cols-2 gap-3 border-2">
          <button
            onClick={() => admin.setNavigate("today-task")}
            className="bg-[#19ACC1] py-5 px-6 rounded-md font-bold text-2xl text-white"
          >
            Production Plan
          </button>
          <button
            onClick={() => admin.setNavigate("work-order-selection")}
            className="bg-[#19ACC1] py-5 px-6 rounded-md font-bold text-2xl text-white"
          >
            Preparation
          </button>
          <button
            onClick={() => admin.setNavigate("production-problem")}
            className="bg-[#F79009] py-5 px-6 rounded-md font-bold text-2xl text-white"
          >
            Production Problem
          </button>
          <button
            onClick={() => admin.setNavigate("additional-material")}
            className="bg-[#F79009] py-5 px-6 rounded-md font-bold text-2xl text-white"
          >
            Data Defect
          </button>
        ...
        <div
          className="col-span-2 row-span-3 flex justify-center items-center border-2"
          onClick={admin.onLogout}
        >
          <button className="py-5 px-16 border-4 border-red-500 text-red-500 text-4xl font-bold">
            Logout
          </button>
        </div>
        ...
        <div className="col-span-6 flex justify-center items-center py-4 border-2">
          <span className={`text-[#FECE00] font-[700] text-4xl `}>
            List 4M+1E
          </span>
        </div>
        ...
        <div className="col-span-6 grid grid-cols-5 gap-3 p-10">
          <button
            onClick={() => admin.setNavigate("method")}
            className="bg-[#19ACC1] py-5 px-6 rounded-md font-bold text-2xl text-white"
          >
            Method
          </button>
          <button
            onClick={() => admin.setNavigate("material")}
            className="bg-[#19ACC1] py-5 px-6 rounded-md font-bold text-2xl text-white"
          >
            Material
          </button>
          <button
            onClick={() => admin.setNavigate("equipment")}
            className="bg-[#19ACC1] py-5 px-6 rounded-md font-bold text-2xl text-white"
          >
            Equipment
          </button>
          <button
            onClick={() => admin.setNavigate("manpower")}
            className="bg-[#19ACC1] py-5 px-6 rounded-md font-bold text-2xl text-white"
          >
            Manpower
          </button>
          <button
            onClick={() => admin.setNavigate("layout")}
            className="bg-[#19ACC1] py-5 px-6 rounded-md font-bold text-2xl text-white"
          >
            Layout
          </button>
